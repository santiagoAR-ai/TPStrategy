...
public class TestE1 {
    ...
    public void testColectivosSur() {
        var producto1 = new Envio("televisor", Destinos.CapitalFederal, 4.0f);
        var producto2 = new Envio("Cocina", Destinos.GranBuenosAires, 50.0f);
        var producto3 = new Envio("Celular", Destinos.OtroDestino, 6.0f);
